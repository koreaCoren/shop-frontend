            ...
            <div className="wrap">
                <Style.Info>
                    ...
                    <Style.Content>
                        ...
                        <div className="info">
                            <Style.DetailInfo>
                                <li><b>판매가</b><span className="pay">{productDetail?.goods_price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</span></li>
                                <li><b>할인률</b><span>{productDetail?.goods_sale}%</span></li>
                                <li><b>국내해외배송</b><span>국내배송</span></li>
                                <li><b>배송방법</b><span>택배</span></li>
                                <li><b>배송비</b><span>{deliveryPay.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')} (50,000 이상 구매시 무료)</span></li>
                            </Style.DetailInfo>
                            <p>(최소주문수량 1개 이상)</p>
                            <Style.Quantity>
                                ...
                                <div className="money">{Math.ceil(productDetail?.goods_price - (productDetail?.goods_price * (productDetail?.goods_sale * 0.01))).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</div>
                            </Style.Quantity>
                            <Style.Total>
